...
def TensorBoard(loss, I1PH, I2PH, prVal, Label1PH, Label2PH, Args, summary_level='full'):
    ...
    if Args.NetworkName == 'Network.MultiScaleResNet':
        ...
        prFlowVis_final, _, _ = flow_viz_tf(AccumPreds(prVal))
    ...
    elif Args.NetworkName == 'Network.MultiScaleResNet' or Args.NetworkName == 'Network.MultiScaleMBResNet':
...
def PrettyPrint(Args, NumParams, NumFlops, ModelSize, VN, OverideKbInput=False):
    ...
    cprint('Init Neurons {}, Expansion Factor {}, NumBlocks {}, NumSubBlocks {}, DropOutFactor {}'.format(VN.InitNeurons, VN.ExpansionFactor, VN.NumBlocks, VN.NumSubBlocks, VN.DropOutRate), 'yellow')
    ...
    if Key.lower() == 'y' or Key.lower() == 'yes':
        ...
        with open(FileName, 'w+') as RunCommand:
            ...
            RunCommand.write('Init Neurons {}, Expansion Factor {}, NumBlocks {}, NumSubBlocks {}, DropOutFactor {}\n'.format(VN.InitNeurons, VN.ExpansionFactor, VN.NumBlocks, VN.NumSubBlocks, VN.DropOutRate))
